...
* add copy mode save ([6b0865e](https://github.com/sashahino14/puter-js/commit/6b0865e2841934385111709331c86ed4716f585d))
* **aws/polly:** add new apis to puter-js, add new args to txt2speech ([#1337](https://github.com/sashahino14/puter-js/issues/1337)) ([0b6dbe5](https://github.com/sashahino14/puter-js/commit/0b6dbe587a943f3b283be382fc12690034ec26c0))
* button to remove profile image [#1245](https://github.com/sashahino14/puter-js/issues/1245) ([#1246](https://github.com/sashahino14/puter-js/issues/1246)) ([dad72c5](https://github.com/sashahino14/puter-js/commit/dad72c5bd709ed5e176c6c82ef4c64eaeb78f92f))
* **gui:** Add animation effects to the taskbar ([#1365](https://github.com/sashahino14/puter-js/issues/1365)) ([212bc88](https://github.com/sashahino14/puter-js/commit/212bc88c8f7561a7b1dc9bac3d5308ec2275c8e1))
* implement authentication UI in Puter.js's test UI ([3def1d4](https://github.com/sashahino14/puter-js/commit/3def1d4d7c03f784f26edbb802f2478aa16f0eea))
* implement settings management and modal in puter.js test framework ([9ca1f06](https://github.com/sashahino14/puter-js/commit/9ca1f0639a92a0ea5ce43081a4f43e33b02dc08f))
* make it possible to pass signed files to launchApp ([5522cfb](https://github.com/sashahino14/puter-js/commit/5522cfbd52576205c78f5e7db8383b4695ab61f4))
* puter workers ([bddc872](https://github.com/sashahino14/puter-js/commit/bddc872e009abecffc8517a55d5222025fc113e7))


### Bug Fixes

* .startsWith on undefined ([9a12db2](https://github.com/sashahino14/puter-js/commit/9a12db2066abbcccd2aa2626406d308c23725af6))
* (for node 18) import parse-domain as esmodule ([1a9ff9e](https://github.com/sashahino14/puter-js/commit/1a9ff9e954075075683e105d5d0f0d0d45c77db5))
* 1231 ([9a84776](https://github.com/sashahino14/puter-js/commit/9a847760bceefcd13f174bebfdc1ecd5708fa5be))
* add .undefinedOnCancel to showSaveFilePicker ([e8d6381](https://github.com/sashahino14/puter-js/commit/e8d63819a8f31976ad29bf6dcb295a37486eb06a))
* add missing null check ([89b8c8d](https://github.com/sashahino14/puter-js/commit/89b8c8de1dfe9a36b8aef675852821c5ca61b71b))
* add missing unit conversion step ([4b5955b](https://github.com/sashahino14/puter-js/commit/4b5955b45963711bc5d19b0f242971b39be1b058))
* add necessary supporting code for funding update ([1c19086](https://github.com/sashahino14/puter-js/commit/1c1908659262ff1ae7a89191b5adc6c025bd5e98))
* add one I missed previous commit ([5b7b524](https://github.com/sashahino14/puter-js/commit/5b7b52408003c173ec21aa74f5eb756ecf8d77cd))
* add safeguard in case server response is wrong ([cbfb928](https://github.com/sashahino14/puter-js/commit/cbfb9283d10f248976d28f8ab55b5d1c83ca1980))
* add support for new Endpoint usage ([db960d5](https://github.com/sashahino14/puter-js/commit/db960d585a244716e683ac726b25c5e3aba57f95))
* arrow key navigation ([ae07a5e](https://github.com/sashahino14/puter-js/commit/ae07a5e316a16cfff281c25f9b4674f24fe93b65))
* arrow keys unresponsive when selecting items with offset center points ([5fd5017](https://github.com/sashahino14/puter-js/commit/5fd50170801813e29e6c309d0f4e840cf7506eef))
* async handling for events ([d0edb2c](https://github.com/sashahino14/puter-js/commit/d0edb2c1f3c2dd28d3adcaec163af026e7fa4fcc))
* broken model parameter ([27fd7b3](https://github.com/sashahino14/puter-js/commit/27fd7b3670343ebe03efae0e1521f385d5d4d566))
* build error ([5f14dc7](https://github.com/sashahino14/puter-js/commit/5f14dc720be1583f33d9da23bbc59167b0635d8c))
* cannot create shortcut for shared file ([72a4550](https://github.com/sashahino14/puter-js/commit/72a45500d5db68215e1d6c9638a8c629acff9e2d)), closes [#1263](https://github.com/sashahino14/puter-js/issues/1263)
* check funding with no args ([f0c0693](https://github.com/sashahino14/puter-js/commit/f0c06931bd4feae5860b365427fabc3ba253bbe1))
* complete Norwegian Nynorsk translation ([807d7bd](https://github.com/sashahino14/puter-js/commit/807d7bd698a75f011cbbb1df1de3322701088727))
* confirm email with code flow ([7b1fb5d](https://github.com/sashahino14/puter-js/commit/7b1fb5d9a6ce9998c9eed0c4a7f37249cd3d844c))
* consistent email check in confirm-email ([c254b39](https://github.com/sashahino14/puter-js/commit/c254b39afe4855ab3b329fd182b73bd2e99fc61d))
* cost testing model ([f46d47d](https://github.com/sashahino14/puter-js/commit/f46d47d2a8fefee01f1b5570018a6b5c4144e83d))
* don't encrypt session UUID if there isn't one ([d4250d6](https://github.com/sashahino14/puter-js/commit/d4250d65aa16ff8dd7eb81097c5c0c248b5efd55))
* edge case during email change ([fb01bb4](https://github.com/sashahino14/puter-js/commit/fb01bb474aecb4625fbd840436ae4781f86b4cf6))
* enable and fix date command tests ([d885ea5](https://github.com/sashahino14/puter-js/commit/d885ea5772b9aab6dce3092139309df79753d701)), closes [#796](https://github.com/sashahino14/puter-js/issues/796)
* error handling in ThreadService ([95ddfe3](https://github.com/sashahino14/puter-js/commit/95ddfe3909d3279e9a767febda7670cdb8cc3d3b))
* fallback behavior related to fake-chat service ([9bf48e7](https://github.com/sashahino14/puter-js/commit/9bf48e7289cef34b0f1527a5dc0792a7ebf14710))
* file cleanup for Claude when streaming ([50d520f](https://github.com/sashahino14/puter-js/commit/50d520f09935f34bad6420ec8c8373ba2ed7e13c))
* get sharp far away from bundlers as possible ([963b248](https://github.com/sashahino14/puter-js/commit/963b248582a8d2aec67261ca171d48076575b84d))
* gone ([34787bb](https://github.com/sashahino14/puter-js/commit/34787bbb0cfc08dc9e35128ed6549c18709d60a1))
* handle all temp user errors by reloading ([0347a38](https://github.com/sashahino14/puter-js/commit/0347a38136861288cdac8ed35d90c2a428ba2d98))
* handle problematic null or undefined case ([b7efa6f](https://github.com/sashahino14/puter-js/commit/b7efa6f89431836bcd1292d495ba010c2933d9dd))
* iframe overlap issue (PR 1250) ([284b89a](https://github.com/sashahino14/puter-js/commit/284b89a5fd497fc598b2ed2683d7997b3e0094a4)), closes [#1233](https://github.com/sashahino14/puter-js/issues/1233)
* improvements to jaeger trace service ([fd956cb](https://github.com/sashahino14/puter-js/commit/fd956cb1cd23d28b935c3693c29c10208845261f))
* include base reserved words by default ([c7970fd](https://github.com/sashahino14/puter-js/commit/c7970fd1a830dfcbe0e031007bceafeb97bb8084))
* incorrect call to APIError from configurable_auth ([5903f1f](https://github.com/sashahino14/puter-js/commit/5903f1fb31eb1cbbcb0d346ebefc716c9d6e68ad))
* incorrect pricing ([ae4dc23](https://github.com/sashahino14/puter-js/commit/ae4dc23c378c624bd6aa76bd45d201d476445a25))
* install ([2d9526b](https://github.com/sashahino14/puter-js/commit/2d9526ba404bead5beaa87c86712dee4984b28dc))
* issue using ll_write outside of hl_write ([152a557](https://github.com/sashahino14/puter-js/commit/152a5578fce30dff0c183db81b52fc8332947a52))
* make sharp optional ([354b116](https://github.com/sashahino14/puter-js/commit/354b116b424243fac989009612b0e457d0e54e8c))
* move temp users to 'user' group when email is confirmed ([4ba2f97](https://github.com/sashahino14/puter-js/commit/4ba2f97da0654f804a67fdfbf104ad05cb7bc63a))
* necessary updates happen for move save too ([6598798](https://github.com/sashahino14/puter-js/commit/659879812dcf77578103e58d8b9f667c91a8c589))
* pass dedupe_name to mkshortcut via batch ([cecc9f2](https://github.com/sashahino14/puter-js/commit/cecc9f23dca4f07b289355d74b60db626871c931))
* potential log error ([f7b302b](https://github.com/sashahino14/puter-js/commit/f7b302b024ee631794ae6d3a162641bc76924dde))
* prevent entity mutation during upsert ([f2a29d5](https://github.com/sashahino14/puter-js/commit/f2a29d5228fd18a9a71a3dbd6ca67bb42750c86f))
* prevent health check from surpressing traces ([2cd5b3c](https://github.com/sashahino14/puter-js/commit/2cd5b3cb498ca5511b0120b4a007512837e1558f))
* properly update owner object in FSNodeContext ([d17b466](https://github.com/sashahino14/puter-js/commit/d17b466e37eb153bfd0ec3256ed040d0fa4e5291))
* puter.js threads error handling ([fc11eba](https://github.com/sashahino14/puter-js/commit/fc11eba070cb97736d7d464fcc04777235aeb06b))
* redundant report-usage call in FakeChatService ([0201b93](https://github.com/sashahino14/puter-js/commit/0201b9301394f2f4cfa9908071ced7c54018e7c3))
* remaining issues with fake-chat/costly ([7f6b302](https://github.com/sashahino14/puter-js/commit/7f6b3026364b6c4dee8e622aaeec1d039e3ac054))
* remove dormant condition operand from signup.js ([a7d1bf0](https://github.com/sashahino14/puter-js/commit/a7d1bf0e99931f5dda5ec5ed0b3e894b54c82e0d))
* return "null" for file_path and file_uid if backing file is nonexistent ([7d4ee75](https://github.com/sashahino14/puter-js/commit/7d4ee756190b4beac8aba099e696c895d7c77a4f))
* return proper error message when the model is not found ([#1331](https://github.com/sashahino14/puter-js/issues/1331)) ([ade213b](https://github.com/sashahino14/puter-js/commit/ade213b88b82d44139c54ed55992745379d78548)), closes [#1326](https://github.com/sashahino14/puter-js/issues/1326)
* save_account lock timeout ([ccdb678](https://github.com/sashahino14/puter-js/commit/ccdb678937b9742e30061ae39fb7c710389f720c))
* share issue ([518449c](https://github.com/sashahino14/puter-js/commit/518449cfdd1e3ccb8240a8865069e2bb524f8725))
* shortcut KV permissions ([f6e6e8d](https://github.com/sashahino14/puter-js/commit/f6e6e8dff829eb86a4bfa7129f01e4c0b18517db))
* sqlite syntax inconsistency ([75aebd6](https://github.com/sashahino14/puter-js/commit/75aebd6d35f97ff376fc393498031993ba9707b3))
* streaming in FakeChatService ([2e90e8d](https://github.com/sashahino14/puter-js/commit/2e90e8dc960fb18abe3f2120a78df3ddc9085093))
* ui bug in settings window ([77f3bf2](https://github.com/sashahino14/puter-js/commit/77f3bf21770d26b82be32b110ebd4b880e6d348b))
* update package-lock.json ([60a9be1](https://github.com/sashahino14/puter-js/commit/60a9be12badd168446bd8a416cc67dd2c50487a8))
* update refresh_actor cache invalidation ([405564f](https://github.com/sashahino14/puter-js/commit/405564f55fb9ba3b3bcac67774b12d16a69e9724))
* use correct path for openrouter max tokens ([3f5de6d](https://github.com/sashahino14/puter-js/commit/3f5de6d493f7de34e1f2b7924c29d36f97dd14e8))
* use event service ([dc2e406](https://github.com/sashahino14/puter-js/commit/dc2e406cc68ec1c879f4c57038cf356b66190b0f))
* various AI fixes ([4312280](https://github.com/sashahino14/puter-js/commit/43122801bf9dc207843e95fa2f881ff212763b36))
* wrong symbol in previous commit ([ca3acf1](https://github.com/sashahino14/puter-js/commit/ca3acf13c14db089f7ce601de38f470e59988f89))
